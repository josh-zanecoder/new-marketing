...
import ImportedHeadingSidebarPanel from './input-panels/ImportedHeadingSidebarPanel';
import ImportedTextSidebarPanel from './input-panels/ImportedTextSidebarPanel';
import SpacerSidebarPanel from './input-panels/SpacerSidebarPanel';
import TextSidebarPanel from './input-panels/TextSidebarPanel';
import { isEditableBlocksImport } from '../../../utils/exportEmailHtml';
...
export default function ConfigurationPanel() {
  ...
  const importedBlocks = isEditableBlocksImport(document);
  switch (type) {
    case 'Avatar':
    ...
    case 'Heading':
      if (importedBlocks) {
        return <ImportedHeadingSidebarPanel key={selectedBlockId} data={data} />;
      }
    ...
    case 'Text':
      if (importedBlocks) {
        return <ImportedTextSidebarPanel key={selectedBlockId} data={data} />;
      }
