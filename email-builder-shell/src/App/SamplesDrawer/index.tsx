...
import { setSamplesDrawerOpen, useSamplesDrawerOpen } from '../../documents/editor/EditorContext';
...
export default function SamplesDrawer() {
  ...
  return (
    <Drawer
      ...
      onClose={() => setSamplesDrawerOpen(false)}
      ModalProps={{ keepMounted: true }}
      sx={{
        width: samplesDrawerOpen && !overlayDrawers ? SAMPLES_DRAWER_WIDTH : 0,
        flexShrink: 0,
        '& .MuiDrawer-paper': {
