export type MarketingSidebarNavItem = {
  to: string
  label: string
  iconPath: string
}

export const marketingSidebarNavItems: MarketingSidebarNavItem[] = [
  {
    to: '/tenant/dashboard',
    label: 'Dashboard',
    iconPath:
  ...
  },
  {
    ...
    iconPath: 'M3 3v18h18M7 16l4-4 4 4 6-8'
  }
]
