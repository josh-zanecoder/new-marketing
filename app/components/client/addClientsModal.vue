    ...
    >
      <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-slate-200/60">
        ...
        <form class="mt-5 space-y-4" @submit.prevent="handleSubmit">
          <div class="space-y-2">
            <label for="client-name" class="block text-sm font-medium text-slate-700">Client name</label>
            <input
              id="client-name"
              v-model="name"
              type="text"
          ...
          <div class="space-y-2">
            <label for="client-email" class="block text-sm font-medium text-slate-700">Client email</label>
            <input
              id="client-email"
              v-model="email"
              type="email"
...
function handleSubmit() {
  ...
  if (!trimmedEmail) {
    errorMessage.value = 'Client email is required.'
    return
  }
