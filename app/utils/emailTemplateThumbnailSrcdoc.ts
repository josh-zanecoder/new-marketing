...
#preview-wrap{width:${EMAIL_TEMPLATE_THUMB_LAYOUT_WIDTH}px;max-width:${EMAIL_TEMPLATE_THUMB_LAYOUT_WIDTH}px;margin:0 auto;overflow:hidden;background:#fff;box-shadow:0 4px 24px rgba(15,23,42,.08)}
