...
class="font-semibold text-primary-600 cursor-pointer" :disabled="contactsCatalogPending && !contactsCatalog.length"
      ...
      >
        ...
        >
          ...
          <div class="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-end sm:gap-3">
            <button
              type="button"
              class="w-full rounded-xl bg-primary-600 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-primary-600/25 transition-colors hover:bg-primary-700 disabled:opacity-50 sm:order-2 sm:w-auto"
              :disabled="wizardSendBusy"
