    ...
    <div class="mx-auto w-full max-w-3xl">
      ...
      <header class="mb-8 overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-sm shadow-zinc-950/[0.04] ring-1 ring-zinc-100/80 sm:mb-10">
        ...
        <div class="px-5 py-5 sm:px-6 sm:py-6">
          ...
          <p class="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 sm:text-[15px]">
      ...
      >
        <div class="overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-md shadow-zinc-950/[0.05] ring-1 ring-zinc-100/80">
          <div class="h-0.5 bg-gradient-to-r from-violet-500/80 via-violet-400/50 to-zinc-200/70" aria-hidden="true" />
          ...
          <div class="space-y-6 p-5 sm:p-6">
            <div>
              ...
              <input
                ...
                class="w-full rounded-xl border border-zinc-200/90 bg-white px-4 py-3 text-sm text-zinc-900 shadow-sm placeholder:text-zinc-400 transition focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-500/15 sm:text-[15px]"
              >
            </div>
            ...
            <div>
              ...
              <select
                ...
                class="w-full rounded-xl border border-zinc-200/90 bg-white px-4 py-3 text-sm text-zinc-900 shadow-sm transition focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-500/15 disabled:cursor-not-allowed disabled:bg-zinc-50 disabled:text-zinc-500 sm:text-[15px]"
        ...
        <div class="flex flex-col-reverse items-stretch gap-3 pt-2 sm:flex-row sm:justify-end sm:gap-3">
          <NuxtLink
            :to="`/tenant/recipient-list/${listId}`"
            class="inline-flex items-center justify-center rounded-xl border border-zinc-200 bg-white px-5 py-3 text-center text-sm font-semibold text-zinc-800 shadow-sm transition hover:border-zinc-300 hover:bg-zinc-50 sm:text-[15px]"
          ...
          <button
            type="submit"
            class="inline-flex items-center justify-center rounded-xl bg-zinc-900 px-6 py-3 text-sm font-semibold text-white shadow-sm shadow-zinc-900/25 transition hover:bg-zinc-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-900 disabled:opacity-50 sm:px-8 sm:text-[15px]"
