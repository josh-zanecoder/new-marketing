# Custom Marketing — how to send an email

Use **Custom Marketing** when you want to email a whole list, but the message still looks like a normal personal email (like something you’d send from Gmail).

## Quick steps

1. Open **Custom Marketing** in the sidebar.
...
Your message goes out to **everyone** on the selected list through the normal email campaign process. It is not saved as a reusable template in the template library.

## Formatting tools (when writing a message)

These tools appear in the formatting bar above your message:
